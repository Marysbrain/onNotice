...
## Amendment 6 revision plus the failsafe, 2026-07-23, same day

Founder correction: music generation is LOCAL, from the mini, not the paid cloud tier. The living-library doctrine and birth certificates stand unchanged; only the tooling clause is replaced.
